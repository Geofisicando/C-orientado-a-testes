...
- [#81 - Daemon adotado pelo systemd ao invés do init?](https://github.com/Geofisicando/C-orientado-a-testes/tree/main/exemplos/daemon#aula-81---daemon-adotado-pelo-systemd-ao-inv%C3%A9s-do-init)
