...
- [#81 - Configurar o Daemon e o script de serviço para o init](https://github.com/Geofisicando/C-orientado-a-testes/tree/main/exemplos/daemon#aula-81---configurar-o-daemon-e-o-script-de-servi%C3%A7o-do-init)
